...
<html>
	...
	<div class="container">
		<div class="row">
		<a href="newFile" class="btn btn-primary">File Upload Form</a>
		<a href="newCityForm" class="btn btn-primary">CityPage</a>
		<a href="stateForm" class="btn btn-primary">StatePage</a>
		<a href="cityState" class="btn btn-primary">City State Page</a>
		<a href="stateAndCity" class="btn btn-primary">City And State Page</a>
		<a href="addressForm" class="btn btn-primary">Address Page</a>
		<a href="allAddress" class="btn btn-primary">Address Page</a><br>
		<a href="videoForm" class="btn btn-primary">Video Page</a>
		<br>
